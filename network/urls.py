...
urlpatterns = [
    ...
    path('networknode/delete/<int:pk>/', NetworkNodeDeleteAPI.as_view(), name='networknode-delete'),
    path('networknode/update/<int:pk>/', NetworkNodeUpdateAPI.as_view(), name='networknode-update'),
]
